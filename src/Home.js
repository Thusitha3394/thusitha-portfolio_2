...
<div className="border p-4 rounded-lg shadow-sm">
  <h3 className="text-xl font-semibold mb-3">Data Engineering Projects</h3>
  <div className="space-y-4">
    <a href="/projects/data-pipeline" className="block group">
      <img
        src={pipelineImg}
        alt="Real-time Data Pipeline"
        className="w-full max-w-md rounded shadow-md transition-transform group-hover:scale-105"
      />
      <h4 className="mt-2 text-lg font-semibold text-blue-600 underline">
        End-to-End Data Engineering project with AWS S3 + Databricks + PySpark
      </h4>
      <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
      Complete end-to-end data engineering and analytics pipeline for analyzing Indian Premier League (IPL) cricket data. 
      </p>
    </a>
  </div>
</div>
...
<div className="border p-4 rounded-lg shadow-sm mb-6">
  <h3 className="text-xl font-semibold mb-2">Machine Learning Projects</h3>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
      <Link to="/ml-projects/ml-rent-prediction">
        <img
          src={require("./assets/earlybuild.png")}
          alt="Rent Price Prediction app"
          className="rounded-lg hover:opacity-80 transition duration-300"
        />
        <h4 className="mt-2 text-lg font-semibold text-blue-600 underline">
          Predictive model development project in Python , random forest classifier and streamlit
        </h4>
        <p className="mt-2 text-gray-700">
          Real estate rental price prediction app using Random Forest with feature engineering, model tuning, and performance evaluation.
        </p>
      </Link>
    </div>
  </div>
...
<div className="border p-4 rounded-lg shadow-sm">
  <h3 className="text-xl font-semibold mb-1">Deep Learning Projects</h3>
  <p className="text-gray-500">Deep Learning Projects</p>
</div>

{/* Computer Vision Projects */}
<div className="border p-4 rounded-lg shadow-sm">
  <h3 className="text-xl font-semibold mb-1">Computer Vision Projects</h3>
  <p className="text-gray-500">Computer Vision Projects</p>
</div>

{/* LLM & AI Projects */}
<div className="border p-4 rounded-lg shadow-sm">
  <h3 className="text-xl font-semibold mb-1">LLM & AI Projects</h3>
  <p className="text-gray-500">LLM & AI Projects</p>
</div>

{/* Power BI Dashboards */}
<div className="border p-4 rounded-lg shadow-sm">
  <h3 className="text-xl font-semibold mb-1">Power BI Dashboards</h3>
  <p className="text-gray-500">Power BI Dashboards</p>
</div>
